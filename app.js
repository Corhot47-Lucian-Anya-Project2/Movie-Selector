...
// // select the open and close menu buttons
// MovieApp.app.openMenuButton = document.getElementById('openButton');
// MovieApp.app.closeMenuButton = document.getElementById('closeButton');


// // function that closes the menu
// MovieApp.app.closeMenu = function() {
//   document.getElementById("slideoutMenu").style.width = "0";
// };

// MovieApp.app.mediaQuery = function () {
//   let mq = window.matchMedia('(max-width: 700px)');
//   // if screen size is less than 700px
//   if (mq.matches) {
//     MovieApp.app.openMenuButton.addEventListener("click", () => {
//       document.getElementById("slideoutMenu").style.width = "100vw";
//     });

//     // when close menu button is pressed the slide out menu is closed
//     MovieApp.app.closeMenuButton.addEventListener("click", () => {
//       MovieApp.app.closeMenu();
//     });
